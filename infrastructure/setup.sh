...
#cron jobs
crontab -l | { cat; echo "0 */6 * * * python3 /opt/work/Detetor-Discurso-Odio/classificador/worker/normalizador.py"; } | crontab -
crontab -l | { cat; echo "0 */12 * * * node /opt/work/Detetor-Discurso-Odio/classificador/worker/csvUpdate.js"; } | crontab -
